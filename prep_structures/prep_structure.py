...
if __name__ == "__main__":
    ...
    pdb_file_path = "/home/hp/results/MOUSE/level19/F48Y/minim/minim.pdb"  # Absolute path to PDB file
    mutations_file = "/home/hp/nayanika/github/GPX6/prep_structures/MOUSE/level20.txt"   # Absolute path to mutation list file
