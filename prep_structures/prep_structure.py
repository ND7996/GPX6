...
if __name__ == "__main__":
    ...
    pdb_file_path = "/home/hp/results/HUMAN/level3/S143E/minim/minim.pdb"  # Absolute path to PDB file
    mutations_file = "/home/hp/nayanika/github/GPX6/prep_structures/HUMAN/level4.txt"  # Absolute path to mutation list file
    
    # Ensure output directory exists using an absolute path
    output_dir = "/home/hp/nayanika/github/GPX6/prep_structures/HUMAN/level4"
