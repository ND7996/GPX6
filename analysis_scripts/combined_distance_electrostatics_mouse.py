...
ACTIVE_SITE = [
    ('49', 'X'),   # CYS49 in chain X
    ('83', 'X'),   # GLN83 in chain X
    ('196', 'Y'),  # Residue 196 in chain Y
]
...
OUTPUT_CSV = "mutation_distances_mouse.csv"
OUTPUT_HBOND_CSV = "mutation_hbonds_mouse.csv"

# ==============================================================================
# MOUSE HEATMAP DATA - ΔG* BASED CLASSIFICATION
# ==============================================================================
# Based on ACTUAL AVERAGED ΔG* values from your mouse heatmap data
# WT baseline = 17.68 kcal/mol

# Calculate average ΔG* for each mutation from all levels
MUTATION_AVG_DG = {
    '48': 17.4,   # F48Y
    '52': 17.6,   # T52A (some levels RED, some BLUE - average ~17.6)
    '47': 18.0,   # S47A
    '99': 17.5,   # R99C (variable across levels)
    '54': 14.6,   # T54Q - BLUE (14.62)
    '177': 15.8,  # H177Q - BLUE/mixed
    '144': 16.6,  # H144Q - mixed
    '178': 15.9,  # T178A - BLUE (14.77 avg)
    '74': 16.6,   # G74A
    '143': 16.5,  # E143S (varies 14-19)
    '139': 16.6,  # F139L
    '87': 17.3,   # K87T (varies 14-20)
    '142': 17.6,  # P142S (varies widely)
    '102': 17.0,  # G102S
    '104': 17.2,  # Y104F
    '24': 15.7,   # L24I - BLUE
    '60': 17.1,   # T60A
    '181': 15.5,  # R181S - BLUE (16.38 avg)
    '4': 17.2,    # S4R (but has one HUGE outlier at 27.91)
    '107': 17.0,  # N107S (varies 13-21)
}
...
print("="*70)
print("\nColor scheme (MOUSE ΔG* data - CONTINUOUS COLORMAP):")
print("  🟡 YELLOW = Active site (49, 83, 196)")
print("  🔴 RED = High ΔG* (>18 kcal/mol) - worse than WT")
print("  ⚪ WHITE = Around WT (~17.7 kcal/mol)")
print("  🔵 BLUE = Low ΔG* (<16 kcal/mol) - better than WT")
